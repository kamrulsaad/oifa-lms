   ...
   return (
      <>
         <section className="slider__area slider__height-2 include-bg d-flex align-items-center"
            style={{ background: `url(assets/img/slider/2/slider-2-bg.png)`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
                  ...
                  <div className="col-xxl-6 col-lg-6">
                     <div className="slider__thumb-2 p-relative">
                        <div className="slider__shape">
                           ...
                           <img className="slider__shape-4" src="assets/img/slider/2/shape/slider-shape-1.png" alt="" />
                           <img className="slider__shape-5" src="assets/img/slider/2/shape/slider-shape-2.png" alt="" />
                        </div>
